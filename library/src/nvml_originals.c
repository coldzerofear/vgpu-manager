...
nvmlReturn_t nvmlShutdown(void) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlShutdown);
}
...
nvmlReturn_t nvmlDeviceGetComputeRunningProcesses(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetComputeRunningProcesses,
...
nvmlReturn_t nvmlDeviceGetPciInfo(nvmlDevice_t device, nvmlPciInfo_t *pci) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPciInfo, device, pci);
}
...
nvmlReturn_t nvmlDeviceGetProcessUtilization(
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetProcessUtilization,
...
nvmlReturn_t nvmlDeviceClearEccErrorCounts(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceClearEccErrorCounts,
                         device, counterType);
}

nvmlReturn_t nvmlDeviceDiscoverGpus(nvmlPciInfo_t *pciInfo) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceDiscoverGpus, pciInfo);
}

nvmlReturn_t nvmlDeviceFreezeNvLinkUtilizationCounter(nvmlDevice_t device,
             unsigned int link, unsigned int counter, nvmlEnableState_t freeze) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceFreezeNvLinkUtilizationCounter,
                                                        device, link, counter, freeze);
}

nvmlReturn_t nvmlDeviceGetAccountingBufferSize(nvmlDevice_t device,
                                               unsigned int *bufferSize) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetAccountingBufferSize,
                         device, bufferSize);
}

nvmlReturn_t nvmlDeviceGetAccountingMode(nvmlDevice_t device,
                                         nvmlEnableState_t *mode) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetAccountingMode,
                         device, mode);
}

nvmlReturn_t nvmlDeviceGetAccountingPids(nvmlDevice_t device,
                              unsigned int *count, unsigned int *pids) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetAccountingPids,
                         device, count, pids);
}

nvmlReturn_t nvmlDeviceGetAccountingStats(nvmlDevice_t device, unsigned int pid,
                                          nvmlAccountingStats_t *stats) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetAccountingStats,
                         device, pid, stats);
}
...
nvmlReturn_t nvmlDeviceGetActiveVgpus(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetActiveVgpus, device,
...
nvmlReturn_t nvmlDeviceGetAPIRestriction(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetAPIRestriction,
...
nvmlReturn_t nvmlDeviceGetApplicationsClock(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetApplicationsClock,
...
nvmlReturn_t nvmlDeviceGetBAR1MemoryInfo(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetBAR1MemoryInfo,
                         device, bar1Memory);
}
...
nvmlReturn_t nvmlDeviceGetBoardPartNumber(nvmlDevice_t device, char *partNumber,
                                          unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetBoardPartNumber,
                         device, partNumber, length);
}

nvmlReturn_t nvmlDeviceGetBrand(nvmlDevice_t device, nvmlBrandType_t *type) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetBrand, device, type);
}
...
nvmlReturn_t nvmlDeviceGetCreatableVgpus(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetCreatableVgpus,
                         device, vgpuCount, vgpuTypeIds);
}

nvmlReturn_t nvmlDeviceGetCudaComputeCapability(nvmlDevice_t device, int *major,
                                                int *minor) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetCudaComputeCapability,
                         device, major, minor);
}
...
nvmlReturn_t nvmlDeviceGetCurrPcieLinkWidth(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetCurrPcieLinkWidth,
...
nvmlReturn_t nvmlDeviceGetDecoderUtilization(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetDecoderUtilization,
...
nvmlReturn_t nvmlDeviceGetDetailedEccErrors(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetDetailedEccErrors,
                         device, errorType, counterType, eccCounts);
}

nvmlReturn_t nvmlDeviceGetDisplayActive(nvmlDevice_t device,
                                        nvmlEnableState_t *isActive) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetDisplayActive, device, isActive);
}

nvmlReturn_t nvmlDeviceGetDisplayMode(nvmlDevice_t device,
                                      nvmlEnableState_t *display) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetDisplayMode, device, display);
}

nvmlReturn_t nvmlDeviceGetDriverModel(nvmlDevice_t device,
                                      nvmlDriverModel_t *current,
                                      nvmlDriverModel_t *pending) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetDriverModel, device,
                         current, pending);
}
...
nvmlReturn_t nvmlDeviceGetEccMode(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetEccMode, device,
                         current, pending);
}

nvmlReturn_t nvmlDeviceSetEccMode(nvmlDevice_t device, nvmlEnableState_t ecc) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetEccMode, device, ecc);
}
...
nvmlReturn_t nvmlDeviceGetEncoderCapacity(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetEncoderCapacity,
...
nvmlReturn_t nvmlDeviceGetEncoderSessions(nvmlDevice_t device, unsigned int *sessionCount,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetEncoderSessions,
...
nvmlReturn_t nvmlDeviceGetEncoderStats(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetEncoderStats, device,
...
nvmlReturn_t nvmlDeviceGetEncoderUtilization(nvmlDevice_t device,
                                             unsigned int *utilization,
                                             unsigned int *samplingPeriodUs) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetEncoderUtilization,
                         device, utilization, samplingPeriodUs);
}

nvmlReturn_t nvmlDeviceGetEnforcedPowerLimit(nvmlDevice_t device,
                                             unsigned int *limit) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetEnforcedPowerLimit,
                         device, limit);
}
...
nvmlReturn_t nvmlDeviceGetFieldValues(nvmlDevice_t device, int valuesCount,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetFieldValues, device, valuesCount, values);
}
...
nvmlReturn_t nvmlDeviceGetGpuOperationMode(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuOperationMode,
...
nvmlReturn_t nvmlDeviceGetInforomConfigurationChecksum(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetInforomConfigurationChecksum,
                         device, checksum);
}

nvmlReturn_t nvmlDeviceGetInforomImageVersion(nvmlDevice_t device,
                                              char *version, unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetInforomImageVersion,
...
nvmlReturn_t nvmlDeviceGetInforomVersion(nvmlDevice_t device,
                                         ...
                                         char *version, unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetInforomVersion,
...
nvmlReturn_t nvmlDeviceGetMaxClockInfo(nvmlDevice_t device,
                                       ...
                                       unsigned int *clock) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMaxClockInfo, device,
                         type, clock);
}
...
nvmlReturn_t nvmlDeviceGetMaxCustomerBoostClock(nvmlDevice_t device,
                                                nvmlClockType_t clockType,
                                                unsigned int *clockMHz) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMaxCustomerBoostClock,
                         device, clockType, clockMHz);
}

nvmlReturn_t nvmlDeviceGetMaxPcieLinkGeneration(nvmlDevice_t device,
                                                unsigned int *maxLinkGen) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMaxPcieLinkGeneration,
                         device, maxLinkGen);
}

nvmlReturn_t nvmlDeviceGetMaxPcieLinkWidth(nvmlDevice_t device,
                                           unsigned int *maxLinkWidth) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMaxPcieLinkWidth,
                         device, maxLinkWidth);
}
...
nvmlReturn_t nvmlDeviceGetMemoryErrorCounter(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMemoryErrorCounter,
...
nvmlReturn_t nvmlDeviceGetMinorNumber(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMinorNumber, device, minorNumber);
}
...
nvmlReturn_t nvmlDeviceGetMPSComputeRunningProcesses_v2(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMPSComputeRunningProcesses_v2,
                         device, infoCount, infos);
}

nvmlReturn_t nvmlDeviceGetMPSComputeRunningProcesses(nvmlDevice_t device,
                                                     unsigned int *infoCount, void *infos) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMPSComputeRunningProcesses,
                         device, infoCount, infos);
}

nvmlReturn_t nvmlDeviceGetMultiGpuBoard(nvmlDevice_t device, unsigned int *multiGpuBool) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMultiGpuBoard, device, multiGpuBool);
}

nvmlReturn_t nvmlDeviceGetName(nvmlDevice_t device, char *name, unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetName, device, name, length);
}
...
nvmlReturn_t nvmlDeviceGetNvLinkCapability(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetNvLinkCapability,
...
nvmlReturn_t nvmlDeviceGetNvLinkErrorCounter(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetNvLinkErrorCounter,
...
nvmlReturn_t nvmlDeviceGetNvLinkRemotePciInfo_v2(nvmlDevice_t device,
                                                 unsigned int link,
                                                 nvmlPciInfo_t *pci) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetNvLinkRemotePciInfo_v2,
                         device, link, pci);
}
...
nvmlReturn_t nvmlDeviceGetNvLinkRemotePciInfo(nvmlDevice_t device,
                                              unsigned int link,
                                              nvmlPciInfo_t *pci) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetNvLinkRemotePciInfo,
                         device, link, pci);
}

nvmlReturn_t nvmlDeviceGetNvLinkState(nvmlDevice_t device, unsigned int link,
                                      nvmlEnableState_t *isActive) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetNvLinkState, device,
                         link, isActive);
}

nvmlReturn_t nvmlDeviceGetNvLinkUtilizationControl(nvmlDevice_t device, unsigned int link,
                         unsigned int counter, nvmlNvLinkUtilizationControl_t *control) {
  return NVML_ENTRY_CHECK(nvml_library_entry,
...
nvmlReturn_t nvmlDeviceGetNvLinkVersion(nvmlDevice_t device, unsigned int link,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetNvLinkVersion,
                         device, link, version);
}
...
nvmlReturn_t nvmlDeviceGetP2PStatus(nvmlDevice_t device1, nvmlDevice_t device2,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetP2PStatus, device1,
                         device2, p2pIndex, p2pStatus);
}

nvmlReturn_t nvmlDeviceGetPcieReplayCounter(nvmlDevice_t device,
                                            unsigned int *value) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPcieReplayCounter,
                         device, value);
}
...
nvmlReturn_t nvmlDeviceGetPcieThroughput(nvmlDevice_t device,
                                         ...
                                         unsigned int *value) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPcieThroughput,
                         device, counter, value);
}

nvmlReturn_t nvmlDeviceGetPerformanceState(nvmlDevice_t device,
                                           nvmlPstates_t *pState) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPerformanceState,
                         device, pState);
}
...
nvmlReturn_t nvmlDeviceGetPowerManagementLimit(nvmlDevice_t device, unsigned int *limit) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPowerManagementLimit,
                         device, limit);
}
...
nvmlReturn_t nvmlDeviceGetPowerManagementMode(nvmlDevice_t device,
                                              nvmlEnableState_t *mode) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPowerManagementMode,
                         device, mode);
}

nvmlReturn_t nvmlDeviceGetPowerState(nvmlDevice_t device, nvmlPstates_t *pState) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPowerState, device, pState);
}

nvmlReturn_t nvmlDeviceGetPowerUsage(nvmlDevice_t device, unsigned int *power) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPowerUsage, device, power);
}
...
nvmlReturn_t nvmlDeviceGetRetiredPages(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetRetiredPages, device,
...
nvmlReturn_t nvmlDeviceGetRetiredPagesPendingStatus(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetRetiredPagesPendingStatus,
                         device, isPending);
}
...
nvmlReturn_t nvmlDeviceGetSamples(nvmlDevice_t device, nvmlSamplingType_t type,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetSamples, device, type,
                         lastSeenTimeStamp, sampleValType, sampleCount, samples);
}

nvmlReturn_t nvmlDeviceGetSerial(nvmlDevice_t device,
                                char *serial, unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetSerial,
...
nvmlReturn_t nvmlDeviceGetSupportedEventTypes(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetSupportedEventTypes,
                         device, eventTypes);
}
...
nvmlReturn_t nvmlDeviceGetSupportedGraphicsClocks(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetSupportedGraphicsClocks,
...
nvmlReturn_t nvmlDeviceGetSupportedMemoryClocks(nvmlDevice_t device,
                                                unsigned int *count,
                                                unsigned int *clocksMHz) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetSupportedMemoryClocks,
...
nvmlReturn_t nvmlDeviceGetSupportedVgpus(nvmlDevice_t device,
                                         unsigned int *vgpuCount,
                                         nvmlVgpuTypeId_t *vgpuTypeIds) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetSupportedVgpus,
                         device, vgpuCount, vgpuTypeIds);
}
...
nvmlReturn_t nvmlDeviceGetTemperature(nvmlDevice_t device,
                                      ...
                                      unsigned int *temp) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetTemperature, device,
                         sensorType, temp);
}
...
nvmlReturn_t nvmlDeviceGetTemperatureThreshold(nvmlDevice_t device,
                                               ...
                                               unsigned int *temp) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetTemperatureThreshold,
...
nvmlReturn_t nvmlDeviceGetTopologyCommonAncestor(nvmlDevice_t device1, nvmlDevice_t device2,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetTopologyCommonAncestor,
...
nvmlReturn_t nvmlDeviceGetTopologyNearestGpus(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetTopologyNearestGpus,
...
nvmlReturn_t nvmlDeviceGetTotalEccErrors(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetTotalEccErrors,
                         device, errorType, counterType, eccCounts);
}
...
nvmlReturn_t nvmlDeviceGetUtilizationRates(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetUtilizationRates,
                         device, utilization);
}

nvmlReturn_t nvmlDeviceGetUUID(nvmlDevice_t device, char *uuid, unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetUUID, device, uuid, length);
}

nvmlReturn_t nvmlDeviceGetVbiosVersion(nvmlDevice_t device, char *version, unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetVbiosVersion, device, version, length);
}

nvmlReturn_t nvmlDeviceGetVgpuMetadata(nvmlDevice_t device,
                                       nvmlVgpuPgpuMetadata_t *pgpuMetadata,
                                       unsigned int *bufferSize) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetVgpuMetadata, device,
                         pgpuMetadata, bufferSize);
}

nvmlReturn_t nvmlDeviceGetVgpuProcessUtilization(nvmlDevice_t device, unsigned long long lastSeenTimeStamp,
                unsigned int *vgpuProcessSamplesCount, nvmlVgpuProcessUtilizationSample_t *utilizationSamples) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetVgpuProcessUtilization, device,
...
nvmlReturn_t nvmlDeviceGetVgpuUtilization(nvmlDevice_t device, unsigned long long lastSeenTimeStamp,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetVgpuUtilization,
...
nvmlReturn_t nvmlDeviceGetViolationStatus(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetViolationStatus,
...
nvmlReturn_t nvmlDeviceGetVirtualizationMode(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetVirtualizationMode,
                         device, pVirtualMode);
}

nvmlReturn_t nvmlDeviceModifyDrainState(nvmlPciInfo_t *pciInfo,
                                        nvmlEnableState_t newState) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceModifyDrainState,
                         pciInfo, newState);
}

nvmlReturn_t nvmlDeviceOnSameBoard(nvmlDevice_t device1, nvmlDevice_t device2,
                                   int *onSameBoard) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceOnSameBoard, device1,
                         device2, onSameBoard);
}

nvmlReturn_t nvmlDeviceQueryDrainState(nvmlPciInfo_t *pciInfo,
                                       nvmlEnableState_t *currentState) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceQueryDrainState, pciInfo,
                         currentState);
}
...
nvmlReturn_t nvmlDeviceRegisterEvents(nvmlDevice_t device,
                                      unsigned long long eventTypes,
                                      nvmlEventSet_t set) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceRegisterEvents, device,
                         eventTypes, set);
}
...
nvmlReturn_t nvmlDeviceRemoveGpu_v2(nvmlPciInfo_t *pciInfo,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceRemoveGpu_v2, pciInfo,
                         gpuState, linkState);
}
...
nvmlReturn_t nvmlDeviceRemoveGpu(nvmlPciInfo_t *pciInfo,
                                 nvmlDetachGpuState_t gpuState,
                                 nvmlPcieLinkState_t linkState) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceRemoveGpu, pciInfo,
                         gpuState, linkState);
}

nvmlReturn_t nvmlDeviceResetApplicationsClocks(nvmlDevice_t device) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceResetApplicationsClocks,
                         device);
}

nvmlReturn_t nvmlDeviceResetNvLinkErrorCounters(nvmlDevice_t device,
                                                unsigned int link) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceResetNvLinkErrorCounters,
                         device, link);
}
...
nvmlReturn_t nvmlDeviceSetAccountingMode(nvmlDevice_t device,
                                         nvmlEnableState_t mode) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetAccountingMode,
                         device, mode);
}
...
nvmlReturn_t nvmlDeviceSetAPIRestriction(nvmlDevice_t device,
                                         nvmlRestrictedAPI_t apiType,
                                         nvmlEnableState_t isRestricted) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetAPIRestriction,
                         device, apiType, isRestricted);
}
...
nvmlReturn_t nvmlDeviceSetApplicationsClocks(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetApplicationsClocks,
...
nvmlReturn_t nvmlDeviceSetAutoBoostedClocksEnabled(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetAutoBoostedClocksEnabled,
                         device, enabled);
}

nvmlReturn_t nvmlDeviceSetCpuAffinity(nvmlDevice_t device) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetCpuAffinity, device);
}
...
nvmlReturn_t nvmlDeviceSetDefaultAutoBoostedClocksEnabled(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetDefaultAutoBoostedClocksEnabled,
...
nvmlReturn_t nvmlDeviceSetDriverModel(nvmlDevice_t device,
                                      ...
                                      unsigned int flags) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetDriverModel, device,
                         driverModel, flags);
}

nvmlReturn_t nvmlDeviceSetGpuOperationMode(nvmlDevice_t device,
                                           nvmlGpuOperationMode_t mode) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetGpuOperationMode,
                         device, mode);
}
...
nvmlReturn_t nvmlDeviceSetPersistenceMode(nvmlDevice_t device, nvmlEnableState_t mode) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetPersistenceMode, device, mode);
}

nvmlReturn_t nvmlDeviceSetPowerManagementLimit(nvmlDevice_t device, unsigned int limit) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetPowerManagementLimit, device, limit);
}

nvmlReturn_t nvmlDeviceSetVirtualizationMode(nvmlDevice_t device,
                                             nvmlGpuVirtualizationMode_t virtualMode) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetVirtualizationMode,
                         device, virtualMode);
}

nvmlReturn_t nvmlDeviceValidateInforom(nvmlDevice_t device) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceValidateInforom, device);
}

nvmlReturn_t nvmlEventSetCreate(nvmlEventSet_t *set) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlEventSetCreate, set);
}

nvmlReturn_t nvmlEventSetFree(nvmlEventSet_t set) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlEventSetFree, set);
}

nvmlReturn_t nvmlEventSetWait(nvmlEventSet_t set, nvmlEventData_t *data,
                              unsigned int timeoutms) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlEventSetWait, set, data, timeoutms);
}

nvmlReturn_t nvmlGetVgpuCompatibility(nvmlVgpuMetadata_t *vgpuMetadata,
                                      nvmlVgpuPgpuMetadata_t *pgpuMetadata,
                                      nvmlVgpuPgpuCompatibility_t *compatibilityInfo) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGetVgpuCompatibility,
                         vgpuMetadata, pgpuMetadata, compatibilityInfo);
}

nvmlReturn_t nvmlInternalGetExportTable(const void **ppExportTable,
                                        void *pExportTableId) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlInternalGetExportTable,
                         ppExportTable, pExportTableId);
}

nvmlReturn_t nvmlSystemGetCudaDriverVersion(int *cudaDriverVersion) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetCudaDriverVersion,
                         cudaDriverVersion);
}

nvmlReturn_t nvmlSystemGetCudaDriverVersion_v2(int *cudaDriverVersion) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetCudaDriverVersion_v2,
                         cudaDriverVersion);
}

nvmlReturn_t nvmlSystemGetDriverVersion(char *version, unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetDriverVersion,
                         version, length);
}

nvmlReturn_t nvmlSystemGetHicVersion(unsigned int *hwbcCount,
                                     nvmlHwbcEntry_t *hwbcEntries) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetHicVersion, hwbcCount, hwbcEntries);
}

nvmlReturn_t nvmlSystemGetNVMLVersion(char *version, unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetNVMLVersion, version, length);
}

nvmlReturn_t nvmlSystemGetProcessName(unsigned int pid, char *name,
                                      unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetProcessName, pid,
                         name, length);
}
...
nvmlReturn_t nvmlSystemGetTopologyGpuSet(unsigned int cpuNumber,
                                         unsigned int *count,
                                         nvmlDevice_t *deviceArray) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetTopologyGpuSet,
                         cpuNumber, count, deviceArray);
}

nvmlReturn_t nvmlUnitGetCount(unsigned int *unitCount) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlUnitGetCount, unitCount);
}

nvmlReturn_t nvmlUnitGetDevices(nvmlUnit_t unit, unsigned int *deviceCount,
                                nvmlDevice_t *devices) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlUnitGetDevices, unit,
                         deviceCount, devices);
}

nvmlReturn_t nvmlUnitGetFanSpeedInfo(nvmlUnit_t unit,
                                     nvmlUnitFanSpeeds_t *fanSpeeds) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlUnitGetFanSpeedInfo, unit,
                         fanSpeeds);
}

nvmlReturn_t nvmlUnitGetHandleByIndex(unsigned int index, nvmlUnit_t *unit) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlUnitGetHandleByIndex, index,
                         unit);
}

nvmlReturn_t nvmlUnitGetLedState(nvmlUnit_t unit, nvmlLedState_t *state) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlUnitGetLedState, unit, state);
}

nvmlReturn_t nvmlUnitGetPsuInfo(nvmlUnit_t unit, nvmlPSUInfo_t *psu) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlUnitGetPsuInfo, unit, psu);
}

nvmlReturn_t nvmlUnitGetTemperature(nvmlUnit_t unit, unsigned int type,
                                    unsigned int *temp) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlUnitGetTemperature, unit, type,
                         temp);
}

nvmlReturn_t nvmlUnitGetUnitInfo(nvmlUnit_t unit, nvmlUnitInfo_t *info) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlUnitGetUnitInfo, unit, info);
}

nvmlReturn_t nvmlUnitSetLedState(nvmlUnit_t unit, nvmlLedColor_t color) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlUnitSetLedState, unit, color);
}

nvmlReturn_t nvmlVgpuInstanceGetEncoderCapacity(nvmlVgpuInstance_t vgpuInstance,
                                                unsigned int *encoderCapacity) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetEncoderCapacity,
...
nvmlReturn_t nvmlVgpuInstanceGetEncoderSessions(nvmlVgpuInstance_t vgpuInstance,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetEncoderSessions,
...
nvmlReturn_t nvmlVgpuInstanceGetEncoderStats(nvmlVgpuInstance_t vgpuInstance,
                                             ...
                                             unsigned int *averageFps,
                                             unsigned int *averageLatency) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetEncoderStats,
...
nvmlReturn_t nvmlVgpuInstanceGetFbUsage(nvmlVgpuInstance_t vgpuInstance,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetFbUsage,
                         vgpuInstance, fbUsage);
}

nvmlReturn_t nvmlVgpuInstanceGetFrameRateLimit(nvmlVgpuInstance_t vgpuInstance,
                                               unsigned int *frameRateLimit) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetFrameRateLimit,
...
nvmlReturn_t nvmlVgpuInstanceGetLicenseStatus(nvmlVgpuInstance_t vgpuInstance,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetLicenseStatus,
...
nvmlReturn_t nvmlVgpuInstanceGetMetadata(nvmlVgpuInstance_t vgpuInstance,
                                         ...
                                         unsigned int *bufferSize) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetMetadata,
...
nvmlReturn_t nvmlVgpuInstanceGetType(nvmlVgpuInstance_t vgpuInstance,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetType,
                         vgpuInstance, vgpuTypeId);
}

nvmlReturn_t nvmlVgpuInstanceGetUUID(nvmlVgpuInstance_t vgpuInstance,
                                     char *uuid, unsigned int size) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetUUID,
...
nvmlReturn_t nvmlVgpuInstanceGetVmDriverVersion(nvmlVgpuInstance_t vgpuInstance,
                                                char *version,
                                                unsigned int length) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetVmDriverVersion,
...
nvmlReturn_t nvmlVgpuInstanceGetVmID(nvmlVgpuInstance_t vgpuInstance,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetVmID,
                         vgpuInstance, vmId, size, vmIdType);
}

nvmlReturn_t nvmlVgpuInstanceSetEncoderCapacity(nvmlVgpuInstance_t vgpuInstance,
                                                unsigned int encoderCapacity) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceSetEncoderCapacity,
                         vgpuInstance, encoderCapacity);
}

nvmlReturn_t nvmlVgpuTypeGetClass(nvmlVgpuTypeId_t vgpuTypeId,
                                  char *vgpuTypeClass, unsigned int *size) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetClass, vgpuTypeId,
                         vgpuTypeClass, size);
}
...
nvmlReturn_t nvmlVgpuTypeGetDeviceID(nvmlVgpuTypeId_t vgpuTypeId,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetDeviceID,
...
nvmlReturn_t nvmlVgpuTypeGetFramebufferSize(nvmlVgpuTypeId_t vgpuTypeId,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetFramebufferSize,
                         vgpuTypeId, fbSize);
}

nvmlReturn_t nvmlVgpuTypeGetFrameRateLimit(nvmlVgpuTypeId_t vgpuTypeId,
                                           unsigned int *frameRateLimit) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetFrameRateLimit,
...
nvmlReturn_t nvmlVgpuTypeGetLicense(nvmlVgpuTypeId_t vgpuTypeId,
                                    ...
                                    unsigned int size) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetLicense, vgpuTypeId,
...
nvmlReturn_t nvmlVgpuTypeGetMaxInstances(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetMaxInstances,
...
nvmlReturn_t nvmlVgpuTypeGetName(nvmlVgpuTypeId_t vgpuTypeId,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetName, vgpuTypeId,
                         vgpuTypeName, size);
}

nvmlReturn_t nvmlVgpuTypeGetNumDisplayHeads(nvmlVgpuTypeId_t vgpuTypeId,
                                            unsigned int *numDisplayHeads) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetNumDisplayHeads,
...
nvmlReturn_t nvmlVgpuTypeGetResolution(nvmlVgpuTypeId_t vgpuTypeId,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetResolution,
...
nvmlReturn_t nvmlDeviceGetFBCStats(nvmlDevice_t device, nvmlFBCStats_t *fbcStats) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetFBCStats, device, fbcStats);
}
...
nvmlReturn_t nvmlDeviceResetGpuLockedClocks(nvmlDevice_t device) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceResetGpuLockedClocks, device);
}

nvmlReturn_t nvmlDeviceSetGpuLockedClocks(nvmlDevice_t device,
                                          unsigned int minGpuClockMHz,
                                          unsigned int maxGpuClockMHz) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetGpuLockedClocks,
                         device, minGpuClockMHz, maxGpuClockMHz);
}

nvmlReturn_t nvmlGetBlacklistDeviceCount(unsigned int *deviceCount) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGetBlacklistDeviceCount, deviceCount);
}

nvmlReturn_t nvmlGetBlacklistDeviceInfoByIndex(unsigned int index,
                                               nvmlBlacklistDeviceInfo_t *info) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGetBlacklistDeviceInfoByIndex, index, info);
}

nvmlReturn_t nvmlVgpuInstanceGetAccountingMode(nvmlVgpuInstance_t vgpuInstance,
                                               nvmlEnableState_t *mode) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetAccountingMode,
                         vgpuInstance, mode);
}
...
nvmlReturn_t nvmlVgpuInstanceGetAccountingPids(nvmlVgpuInstance_t vgpuInstance,
                                               unsigned int *count,
                                               unsigned int *pids) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetAccountingPids,
...
nvmlReturn_t nvmlVgpuInstanceGetAccountingStats(nvmlVgpuInstance_t vgpuInstance,
                                                unsigned int pid,
                                                nvmlAccountingStats_t *stats) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetAccountingStats,
...
nvmlReturn_t nvmlVgpuInstanceGetFBCSessions(nvmlVgpuInstance_t vgpuInstance,
                                            unsigned int *sessionCount,
                                            nvmlFBCSessionInfo_t *sessionInfo) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetFBCSessions,
                         vgpuInstance, sessionCount, sessionInfo);
}

nvmlReturn_t nvmlVgpuInstanceGetFBCStats(nvmlVgpuInstance_t vgpuInstance,
                                         nvmlFBCStats_t *fbcStats) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetFBCStats,
...
nvmlReturn_t nvmlVgpuTypeGetMaxInstancesPerVm(nvmlVgpuTypeId_t vgpuTypeId,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetMaxInstancesPerVm,
                         vgpuTypeId, vgpuInstanceCountPerVm);
}

nvmlReturn_t nvmlGetVgpuVersion(nvmlVgpuVersion_t *supported,
                                nvmlVgpuVersion_t *current) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGetVgpuVersion, supported,
                         current);
}

nvmlReturn_t nvmlSetVgpuVersion(nvmlVgpuVersion_t *vgpuVersion) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSetVgpuVersion, vgpuVersion);
}

nvmlReturn_t nvmlDeviceGetGridLicensableFeatures_v3(nvmlDevice_t device,
                    nvmlGridLicensableFeatures_t *pGridLicensableFeatures) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGridLicensableFeatures_v3,
                         device, pGridLicensableFeatures);
}

nvmlReturn_t nvmlDeviceGetHostVgpuMode(nvmlDevice_t device,
                                       nvmlHostVgpuMode_t *pHostVgpuMode) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetHostVgpuMode, device,
                         pHostVgpuMode);
}
...
nvmlReturn_t nvmlDeviceGetPgpuMetadataString(nvmlDevice_t device,
                                             char *pgpuMetadata,
                                             unsigned int *bufferSize) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPgpuMetadataString,
...
nvmlReturn_t nvmlDeviceGetCpuAffinityWithinScope(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetCpuAffinityWithinScope,
                         device, cpuSetSize, cpuSet, scope);
}

nvmlReturn_t nvmlDeviceGetDeviceHandleFromMigDeviceHandle(nvmlDevice_t migDevice,
                                                          nvmlDevice_t *device) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetDeviceHandleFromMigDeviceHandle,
                         migDevice, device);
}

nvmlReturn_t nvmlDeviceGetGpuInstanceById(nvmlDevice_t device, unsigned int id,
                                          nvmlGpuInstance_t *gpuInstance) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuInstanceById,
                         device, id, gpuInstance);
}

nvmlReturn_t nvmlDeviceGetGpuInstanceId(nvmlDevice_t device, unsigned int *id) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuInstanceId, device, id);
}

nvmlReturn_t nvmlDeviceGetGpuInstancePossiblePlacements_v2(nvmlDevice_t device, unsigned int profileId,
                                            nvmlGpuInstancePlacement_t *placements, unsigned int *count) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuInstancePossiblePlacements_v2,
...
nvmlReturn_t nvmlDeviceGetGpuInstancePossiblePlacements(nvmlDevice_t device, unsigned int profileId,
                                        nvmlGpuInstancePlacement_t *placements, unsigned int *count) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuInstancePossiblePlacements,
                         device, profileId, placements, count);
}

nvmlReturn_t nvmlDeviceGetGpuInstanceProfileInfo(nvmlDevice_t device, unsigned int profile,
                                                 nvmlGpuInstanceProfileInfo_t *info) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuInstanceProfileInfo,
                         device, profile, info);
}
...
nvmlReturn_t nvmlDeviceGetGpuInstanceRemainingCapacity(nvmlDevice_t device,
                                                       ...
                                                       unsigned int *count) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuInstanceRemainingCapacity,
...
nvmlReturn_t nvmlDeviceGetGpuInstances(nvmlDevice_t device,
                                       ...
                                       unsigned int *count) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuInstances, device,
                         profileId, gpuInstances, count);
}

nvmlReturn_t nvmlDeviceGetMaxMigDeviceCount(nvmlDevice_t device, unsigned int *count) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMaxMigDeviceCount,
                         device, count);
}
...
nvmlReturn_t nvmlDeviceGetMemoryAffinity(nvmlDevice_t device, unsigned int nodeSetSize,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMemoryAffinity,
...
nvmlReturn_t nvmlDeviceGetMigDeviceHandleByIndex(nvmlDevice_t device, unsigned int index,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMigDeviceHandleByIndex,
...
nvmlReturn_t nvmlDeviceGetMigMode(nvmlDevice_t device, unsigned int *currentMode,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMigMode, device,
...
nvmlReturn_t nvmlDeviceGetRemappedRows(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetRemappedRows, device,
...
nvmlReturn_t nvmlDeviceGetRowRemapperHistogram(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetRowRemapperHistogram,
                        device, values);
}

nvmlReturn_t nvmlDeviceIsMigDeviceHandle(nvmlDevice_t device, unsigned int *isMigDevice) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceIsMigDeviceHandle, device, isMigDevice);
}

nvmlReturn_t nvmlDeviceSetMigMode(nvmlDevice_t device, unsigned int mode,
                                          nvmlReturn_t *activationStatus) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetMigMode,
...
nvmlReturn_t nvmlGpuInstanceGetComputeInstanceRemainingCapacity(nvmlGpuInstance_t gpuInstance,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpuInstanceGetComputeInstanceRemainingCapacity,
...
nvmlReturn_t nvmlGpuInstanceGetComputeInstances(nvmlGpuInstance_t gpuInstance,
                                                ...
                                                unsigned int *count) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpuInstanceGetComputeInstances,
...
nvmlReturn_t nvmlGpuInstanceGetInfo(nvmlGpuInstance_t gpuInstance,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpuInstanceGetInfo, gpuInstance, info);
}

nvmlReturn_t nvmlVgpuInstanceClearAccountingPids(nvmlVgpuInstance_t vgpuInstance) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceClearAccountingPids, vgpuInstance);
}

nvmlReturn_t nvmlVgpuInstanceGetMdevUUID(nvmlVgpuInstance_t vgpuInstance,
                                         char *mdevUuid, unsigned int size) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetMdevUUID,
                         vgpuInstance, mdevUuid, size);
}

nvmlReturn_t nvmlComputeInstanceGetInfo_v2(nvmlComputeInstance_t computeInstance,
                                                nvmlComputeInstanceInfo_t *info) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlComputeInstanceGetInfo_v2,
                         computeInstance, info);
}
...
nvmlReturn_t nvmlDeviceGetComputeRunningProcesses_v2(nvmlDevice_t device,
                                                     unsigned int *infoCount,
                                                     nvmlProcessInfo_t *infos) {
  return NVML_ENTRY_CHECK(nvml_library_entry,  nvmlDeviceGetComputeRunningProcesses_v2,
                        device, infoCount, infos);
}

nvmlReturn_t nvmlDeviceGetGraphicsRunningProcesses_v2(nvmlDevice_t device,
                                   unsigned int *infoCount, nvmlProcessInfo_t *infos) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGraphicsRunningProcesses_v2,
                         device, infoCount, infos);
}

nvmlReturn_t nvmlDeviceSetTemperatureThreshold(nvmlDevice_t device,
                         nvmlTemperatureThresholds_t thresholdType, int *temp) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetTemperatureThreshold,
                         device, thresholdType, temp);
}
...
nvmlReturn_t nvmlVgpuInstanceGetGpuInstanceId(nvmlVgpuInstance_t vgpuInstance,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetGpuInstanceId,
...
nvmlReturn_t nvmlVgpuTypeGetGpuInstanceProfileId(nvmlVgpuTypeId_t vgpuTypeId,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetGpuInstanceProfileId,
                         vgpuTypeId, gpuInstanceProfileId);
}

nvmlReturn_t nvmlDeviceCreateGpuInstanceWithPlacement(nvmlDevice_t device, unsigned int profileId,
                                                      const nvmlGpuInstancePlacement_t *placement,
                                                      nvmlGpuInstance_t *gpuInstance){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceCreateGpuInstanceWithPlacement,
                         device, profileId, placement, gpuInstance);
}

nvmlReturn_t nvmlDeviceGetBusType(nvmlDevice_t device, nvmlBusType_t *type) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetBusType, device,
                         type);
}

nvmlReturn_t nvmlDeviceGetClkMonStatus(nvmlDevice_t device, nvmlClkMonStatus_t *status){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetClkMonStatus, device, status);
}

nvmlReturn_t nvmlDeviceGetIrqNum(nvmlDevice_t device, unsigned int *irqNum){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetIrqNum, device, irqNum);
}
...
nvmlReturn_t nvmlDeviceGetNvLinkRemoteDeviceType(nvmlDevice_t device, unsigned int link,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetNvLinkRemoteDeviceType,
                         device, link, pNvLinkDeviceType);
}

nvmlReturn_t nvmlDeviceResetMemoryLockedClocks(nvmlDevice_t device) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceResetMemoryLockedClocks, device);
}

nvmlReturn_t nvmlDeviceSetMemoryLockedClocks(nvmlDevice_t device,
                                             unsigned int minMemClockMHz,
                                             unsigned int maxMemClockMHz) {
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetMemoryLockedClocks,
                         device, minMemClockMHz, maxMemClockMHz);
}

nvmlReturn_t nvmlGetExcludedDeviceCount(unsigned int *deviceCount){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGetExcludedDeviceCount,
                        deviceCount);
}

nvmlReturn_t nvmlGetExcludedDeviceInfoByIndex(unsigned int index,
                                              nvmlExcludedDeviceInfo_t *info){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGetExcludedDeviceInfoByIndex,
                        index, info);
}

nvmlReturn_t nvmlVgpuInstanceGetLicenseInfo(nvmlVgpuInstance_t vgpuInstance,
                                            nvmlVgpuLicenseInfo_t *licenseInfo){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetLicenseInfo,
                        vgpuInstance, licenseInfo);
}

nvmlReturn_t nvmlDeviceClearFieldValues(nvmlDevice_t device,
                              int valuesCount, nvmlFieldValue_t* values){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceClearFieldValues,
                         device, valuesCount, values);
}

nvmlReturn_t nvmlDeviceGetAdaptiveClockInfoStatus(nvmlDevice_t device,
                                               unsigned int* adaptiveClockStatus){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetAdaptiveClockInfoStatus,
                         device, adaptiveClockStatus);
}

nvmlReturn_t nvmlDeviceGetComputeRunningProcesses_v3(nvmlDevice_t device,
                                   unsigned int* infoCount, nvmlProcessInfo_t* infos){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetComputeRunningProcesses_v3,
                         device, infoCount, infos);
}

nvmlReturn_t nvmlDeviceGetDefaultEccMode(nvmlDevice_t device,
                                         nvmlEnableState_t* defaultMode){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetDefaultEccMode,
                         device, defaultMode);
}

nvmlReturn_t nvmlDeviceGetDynamicPstatesInfo(nvmlDevice_t device,
                             nvmlGpuDynamicPstatesInfo_t* pDynamicPstatesInfo){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetDynamicPstatesInfo,
...
//   return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetFanControlPolicy, device, fan, policy);                                  
// }

nvmlReturn_t nvmlDeviceGetFanControlPolicy_v2(nvmlDevice_t device, unsigned int fan,
                                              nvmlFanControlPolicy_t* policy){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetFanControlPolicy_v2, device, fan, policy);                                  
}

nvmlReturn_t nvmlDeviceGetGpcClkMinMaxVfOffset(nvmlDevice_t device, int* minOffset, int* maxOffset){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpcClkMinMaxVfOffset,
                         device, minOffset, maxOffset);
}

nvmlReturn_t nvmlDeviceGetGpcClkVfOffset(nvmlDevice_t device, int* offset){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpcClkVfOffset, device, offset);
}

nvmlReturn_t nvmlDeviceGetGpuFabricInfo(nvmlDevice_t device, nvmlGpuFabricInfo_t* gpuFabricInfo){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuFabricInfo, device, gpuFabricInfo);
}

nvmlReturn_t nvmlDeviceGetGpuInstanceProfileInfoV(nvmlDevice_t device, unsigned int profile,
                                                  nvmlGpuInstanceProfileInfo_v2_t* info){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuInstanceProfileInfoV,
                         device, profile, info);
}

nvmlReturn_t nvmlDeviceGetGpuMaxPcieLinkGeneration(nvmlDevice_t device,
                                                    unsigned int* maxLinkGenDevice){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGpuMaxPcieLinkGeneration,
                        device, maxLinkGenDevice);
}

nvmlReturn_t nvmlDeviceGetGraphicsRunningProcesses_v3(nvmlDevice_t device,
                                    unsigned int* infoCount, nvmlProcessInfo_t* infos){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGraphicsRunningProcesses_v3,
                         device, infoCount, infos);
}

nvmlReturn_t nvmlDeviceGetGspFirmwareMode(nvmlDevice_t device, unsigned int* isEnabled,
                                          unsigned int* defaultMode){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGspFirmwareMode,
                         device, isEnabled, defaultMode);
}

nvmlReturn_t nvmlDeviceGetGspFirmwareVersion(nvmlDevice_t device, char* version){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetGspFirmwareVersion, device, version);
}

nvmlReturn_t nvmlDeviceGetJpgUtilization(nvmlDevice_t device, unsigned int *utilization,
                                         unsigned int *samplingPeriodUs){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetJpgUtilization, device,
                         utilization, samplingPeriodUs);
}

nvmlReturn_t nvmlDeviceGetMemClkMinMaxVfOffset(nvmlDevice_t device,
                                               int* minOffset, int* maxOffset){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMemClkMinMaxVfOffset,
                         device, minOffset, maxOffset);
}

nvmlReturn_t nvmlDeviceGetMemClkVfOffset(nvmlDevice_t device, int* offset){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMemClkVfOffset, device, offset);
}

nvmlReturn_t nvmlDeviceGetMemoryBusWidth(nvmlDevice_t device, unsigned int* busWidth){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMemoryBusWidth, device, busWidth);
}

nvmlReturn_t nvmlDeviceGetMinMaxClockOfPState (nvmlDevice_t device, nvmlClockType_t type,
                                               nvmlPstates_t pstate, unsigned int* minClockMHz,
                                               unsigned int* maxClockMHz){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMinMaxClockOfPState,
                         device, type, pstate, minClockMHz, maxClockMHz);
}

nvmlReturn_t nvmlDeviceGetMinMaxFanSpeed (nvmlDevice_t device, unsigned int* minSpeed,
                                                               unsigned int* maxSpeed){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMinMaxFanSpeed,
                        device, minSpeed, maxSpeed);
}

nvmlReturn_t nvmlDeviceGetModuleId(nvmlDevice_t device, unsigned int *moduleId){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetModuleId, device, moduleId);
}

nvmlReturn_t nvmlDeviceGetMPSComputeRunningProcesses_v3(nvmlDevice_t device,
                                      unsigned int* infoCount, nvmlProcessInfo_t* infos){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetMPSComputeRunningProcesses_v3,
                         device, infoCount, infos);
}

nvmlReturn_t nvmlDeviceGetNumFans(nvmlDevice_t device, unsigned int* numFans){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetNumFans, device, numFans);
}

nvmlReturn_t nvmlDeviceGetNumGpuCores(nvmlDevice_t device, unsigned int* numCores){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetNumGpuCores, device, numCores);
}

nvmlReturn_t nvmlDeviceGetOfaUtilization(nvmlDevice_t device, unsigned int *utilization,
                                                        unsigned int *samplingPeriodUs){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetOfaUtilization,
                         device, utilization, samplingPeriodUs);
}

nvmlReturn_t nvmlDeviceGetPcieLinkMaxSpeed(nvmlDevice_t device, unsigned int* maxSpeed){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPcieLinkMaxSpeed, device, maxSpeed);
}

nvmlReturn_t nvmlDeviceGetPcieSpeed(nvmlDevice_t device, unsigned int* pcieSpeed){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPcieSpeed, device, pcieSpeed);
}

nvmlReturn_t nvmlDeviceGetPowerSource(nvmlDevice_t device, nvmlPowerSource_t* powerSource){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetPowerSource, device, powerSource);
}

nvmlReturn_t nvmlDeviceGetSupportedClocksEventReasons(nvmlDevice_t device,
                                     unsigned long long *supportedClocksEventReasons){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetSupportedClocksEventReasons,
...
nvmlReturn_t nvmlDeviceGetSupportedPerformanceStates(nvmlDevice_t device,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetSupportedPerformanceStates,
                         device, pstates, size);
}

nvmlReturn_t nvmlDeviceGetTargetFanSpeed(nvmlDevice_t device, unsigned int fan,
                                                    unsigned int* targetSpeed){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetTargetFanSpeed,
                        device, fan, targetSpeed);
}

nvmlReturn_t nvmlDeviceGetThermalSettings (nvmlDevice_t device, unsigned int sensorIndex,
                                           nvmlGpuThermalSettings_t* pThermalSettings){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetThermalSettings,
                         device, sensorIndex, pThermalSettings);
}

nvmlReturn_t nvmlDeviceGetVgpuCapabilities(nvmlDevice_t device,
                                           nvmlDeviceVgpuCapability_t capability,
                                           unsigned int* capResult){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetVgpuCapabilities,
                         device, capability, capResult);
}

nvmlReturn_t nvmlGetVgpuDriverCapabilities(nvmlVgpuDriverCapability_t capability,
                                                        unsigned int* capResult){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGetVgpuDriverCapabilities,
                        capability, capResult);
}

nvmlReturn_t nvmlDeviceGetVgpuSchedulerCapabilities(nvmlDevice_t device,
                                     nvmlVgpuSchedulerCapabilities_t* pCapabilities){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetVgpuSchedulerCapabilities,
                         device, pCapabilities);
}

nvmlReturn_t nvmlDeviceGetVgpuSchedulerLog(nvmlDevice_t device,
                                    nvmlVgpuSchedulerLog_t* pSchedulerLog){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetVgpuSchedulerLog,
                        device, pSchedulerLog);
}

nvmlReturn_t nvmlDeviceGetVgpuSchedulerState(nvmlDevice_t device,
                                             nvmlVgpuSchedulerGetState_t* pSchedulerState){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetVgpuSchedulerState,
                        device, pSchedulerState);
}

nvmlReturn_t nvmlDeviceSetVgpuSchedulerState(nvmlDevice_t device,
                                             nvmlVgpuSchedulerSetState_t* pSchedulerState){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetVgpuSchedulerState,
                        device, pSchedulerState);
}

nvmlReturn_t nvmlDeviceSetConfComputeUnprotectedMemSize(nvmlDevice_t device,
                                                            unsigned long long sizeKiB){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetConfComputeUnprotectedMemSize,
                        device, sizeKiB);
}

nvmlReturn_t nvmlDeviceSetDefaultFanSpeed_v2(nvmlDevice_t device, unsigned int fan){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetDefaultFanSpeed_v2, device, fan);
}

nvmlReturn_t nvmlDeviceSetFanControlPolicy(nvmlDevice_t device, unsigned int fan,
                                           nvmlFanControlPolicy_t policy){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetFanControlPolicy, device, fan, policy);
}

nvmlReturn_t nvmlDeviceSetFanSpeed_v2(nvmlDevice_t device, unsigned int fan,
                                                        unsigned int speed){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetFanSpeed_v2,
                        device, fan, speed);
}

nvmlReturn_t nvmlDeviceSetGpcClkVfOffset(nvmlDevice_t device, int  offset){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetGpcClkVfOffset,
                        device, offset);
}

nvmlReturn_t nvmlDeviceSetMemClkVfOffset(nvmlDevice_t device, int  offset){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetMemClkVfOffset,
                        device, offset);
}

nvmlReturn_t nvmlDeviceSetNvLinkDeviceLowPowerThreshold(nvmlDevice_t device,
                                                nvmlNvLinkPowerThres_t *info){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetNvLinkDeviceLowPowerThreshold,
                        device, info);
}

nvmlReturn_t nvmlDeviceSetPowerManagementLimit_v2(nvmlDevice_t device,
                                                nvmlPowerValue_v2_t *powerValue){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceSetPowerManagementLimit_v2,
                        device, powerValue);
}

nvmlReturn_t nvmlGpmMetricsGet(nvmlGpmMetricsGet_t *metricsGet){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpmMetricsGet, metricsGet);
}

nvmlReturn_t nvmlGpmMigSampleGet(nvmlDevice_t device, unsigned int gpuInstanceId,
                                                      nvmlGpmSample_t gpmSample){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpmMigSampleGet,
                        device, gpuInstanceId, gpmSample);
}

nvmlReturn_t nvmlGpmQueryDeviceSupport(nvmlDevice_t device, nvmlGpmSupport_t *gpmSupport){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpmQueryDeviceSupport, gpmSupport);
}

nvmlReturn_t nvmlGpmQueryIfStreamingEnabled(nvmlDevice_t device, unsigned int *state){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpmQueryIfStreamingEnabled, device, state);
}

nvmlReturn_t nvmlGpmSampleAlloc(nvmlGpmSample_t *gpmSample){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpmSampleAlloc, gpmSample);
}

nvmlReturn_t nvmlGpmSampleFree(nvmlGpmSample_t gpmSample){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpmSampleFree, gpmSample);
}

nvmlReturn_t nvmlGpmSampleGet(nvmlDevice_t device, nvmlGpmSample_t gpmSample){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpmSampleGet, device, gpmSample);
}

nvmlReturn_t nvmlGpmSetStreamingEnabled(nvmlDevice_t device, unsigned int state){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpmSetStreamingEnabled, device, state);
}

nvmlReturn_t nvmlGpuInstanceCreateComputeInstanceWithPlacement (nvmlGpuInstance_t gpuInstance,
                                unsigned int profileId, const nvmlComputeInstancePlacement_t* placement,
                                nvmlComputeInstance_t* computeInstance){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpuInstanceCreateComputeInstanceWithPlacement,
                        gpuInstance, profileId, placement, computeInstance);
}

nvmlReturn_t nvmlGpuInstanceGetComputeInstancePossiblePlacements (nvmlGpuInstance_t gpuInstance,
        unsigned int  profileId, nvmlComputeInstancePlacement_t* placements, unsigned int* count){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpuInstanceGetComputeInstancePossiblePlacements,
...
nvmlReturn_t nvmlGpuInstanceGetComputeInstanceProfileInfoV (nvmlGpuInstance_t gpuInstance,
  ...
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlGpuInstanceGetComputeInstanceProfileInfoV,
                        gpuInstance, profile, engProfile, info);
}

nvmlReturn_t nvmlSystemGetConfComputeCapabilities(nvmlConfComputeSystemCaps_t *capabilities){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetConfComputeCapabilities, capabilities);
}

nvmlReturn_t nvmlSystemGetConfComputeGpusReadyState(unsigned int *isAcceptingWork){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetConfComputeGpusReadyState,
                        isAcceptingWork);
}

nvmlReturn_t nvmlSystemGetConfComputeState(nvmlConfComputeSystemState_t *state){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetConfComputeState, state);
}

nvmlReturn_t nvmlSystemGetNvlinkBwMode(unsigned int *nvlinkBwMode){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemGetNvlinkBwMode,
                        nvlinkBwMode);
}

nvmlReturn_t nvmlSystemSetConfComputeGpusReadyState(unsigned int isAcceptingWork){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemSetConfComputeGpusReadyState,
                        isAcceptingWork);
}

nvmlReturn_t nvmlSystemSetNvlinkBwMode(unsigned int nvlinkBwMode){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlSystemSetNvlinkBwMode, nvlinkBwMode);
}

nvmlReturn_t nvmlVgpuInstanceGetGpuPciId(nvmlVgpuInstance_t vgpuInstance,
                                    char *vgpuPciId, unsigned int *length){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetGpuPciId,
                        vgpuInstance, vgpuPciId, length);
}

nvmlReturn_t nvmlVgpuInstanceGetLicenseInfo_v2(nvmlVgpuInstance_t vgpuInstance,
                                            nvmlVgpuLicenseInfo_t *licenseInfo){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuInstanceGetLicenseInfo_v2,
                        vgpuInstance, licenseInfo);
}

nvmlReturn_t nvmlVgpuTypeGetCapabilities(nvmlVgpuTypeId_t vgpuTypeId,
                nvmlVgpuCapability_t capability, unsigned int *capResult){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlVgpuTypeGetCapabilities,
                        vgpuTypeId, capability, capResult);
}

nvmlReturn_t nvmlDeviceGetCurrentClocksEventReasons(nvmlDevice_t device,
                                            unsigned long long *clocksEventReasons){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetCurrentClocksEventReasons,
                         device, clocksEventReasons);
}

nvmlReturn_t nvmlDeviceGetConfComputeProtectedMemoryUsage(nvmlDevice_t device,
                                                          nvmlMemory_t *memory){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetConfComputeProtectedMemoryUsage,
                         device, memory);
}

nvmlReturn_t nvmlDeviceGetConfComputeMemSizeInfo(nvmlDevice_t device,
                                nvmlConfComputeMemSizeInfo_t *memInfo){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetConfComputeMemSizeInfo,
                         device, memInfo);
}

nvmlReturn_t nvmlDeviceGetConfComputeGpuCertificate(nvmlDevice_t device,
                                       nvmlConfComputeGpuCertificate_t *gpuCert){
  return NVML_ENTRY_CHECK(nvml_library_entry, nvmlDeviceGetConfComputeGpuCertificate, device, gpuCert);
}
