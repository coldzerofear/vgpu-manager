...
func NewTimeSlicingManager(deviceLib *nvidia.DeviceLib) *TimeSlicingManager {
	return &TimeSlicingManager{
		nvdevlib: deviceLib,
	}
}

func (t *TimeSlicingManager) SetTimeSlice(devices nvidia.UUIDProvider, config *configapi.TimeSlicingConfig) error {
...
func NewMpsManager(config *Config, deviceLib *nvidia.DeviceLib, hostDriverRoot, templatePath string) *MpsManager {
...
func (m *MpsManager) NewMpsControlDaemon(claimUID string, devices nvidia.UUIDProvider) *MpsControlDaemon {
...
func (m *MpsManager) GetMpsControlDaemonID(claimUID string, devices nvidia.UUIDProvider) string {
