...
func Test_NodePriority(t *testing.T) {
	...
	for i := 0; i < 500000; i++ {
		...
		nodeInfoList[i] = &NodeInfo{
			NodeInfo: device.NewFakeNodeInfo(node, false,
...
func Test_NodeSorting(t *testing.T) {
	...
	nodes := []*NodeInfo{
		{
			NodeInfo: device.NewFakeNodeInfo(nodeA, false,
		...
		{
			NodeInfo: device.NewFakeNodeInfo(nodeB, true,
		...
		{
			NodeInfo: device.NewFakeNodeInfo(nodeC, true,
		...
		{
			NodeInfo: device.NewFakeNodeInfo(nodeD, true,
				device.NewFakeDevice(0, 1, 10, 80, 100, 50000, 80000, 0),
				device.NewFakeDevice(1, 2, 10, 80, 100, 50000, 80000, 0),
				device.NewFakeDevice(2, 3, 10, 80, 100, 50000, 80000, 0),
				device.NewFakeDevice(3, 4, 10, 80, 100, 50000, 80000, 0),
