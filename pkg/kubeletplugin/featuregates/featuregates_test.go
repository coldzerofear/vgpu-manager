...
func TestValidateFeatureGates(t *testing.T) {
	tests := []struct {
		...
		//},
		{
			...
			fgMap:        map[featuregate.Feature]bool{VGPUSupport: false, DynamicMIG: true, PassthroughSupport: true},
			expectError:  true,
		...
		},
		{
			...
			fgMap:        map[featuregate.Feature]bool{VGPUSupport: false, NVMLDeviceHealthCheck: false, DynamicMIG: true, MPSSupport: true},
			expectError:  true,
		...
		},
		{
			...
			fgMap:       map[featuregate.Feature]bool{VGPUSupport: false, DynamicMIG: true, PassthroughSupport: false, NVMLDeviceHealthCheck: false, MPSSupport: false},
			expectError: false,
			description: "should be valid when only DynamicMIG is enabled",
		},
		{
			name:         "PassthroughSupport enabled with NVMLDeviceHealthCheck",
			fgMap:        map[featuregate.Feature]bool{VGPUSupport: false, PassthroughSupport: true, NVMLDeviceHealthCheck: true},
			expectError:  true,
		...
		},
		{
			...
			fgMap:       map[featuregate.Feature]bool{VGPUSupport: false, PassthroughSupport: true, DynamicMIG: false, NVMLDeviceHealthCheck: false, DeviceMetadata: false},
			expectError: false,
		...
		},
		{
			...
			fgMap:        map[featuregate.Feature]bool{VGPUSupport: false, DeviceMetadata: true, PassthroughSupport: false},
			expectError:  true,
		...
		},
		{
			...
			fgMap:       map[featuregate.Feature]bool{VGPUSupport: false, NVMLDeviceHealthCheck: false, DeviceMetadata: true, PassthroughSupport: true},
			expectError: false,
		...
		},
		{
			...
			fgMap:        map[featuregate.Feature]bool{VGPUSupport: false, NVMLDeviceHealthCheck: false, FabricManagerPartitioning: true, PassthroughSupport: false},
			expectError:  true,
