...
func newMigSpec(parentMinor, profileID, placementStart int, pci string) *MigSpec {
	return &MigSpec{
		Parent:        &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{Minor: parentMinor, PciBusID: pci}},
...
func TestAllocatableDeviceType(t *testing.T) {
	tests := map[string]struct {
		...
		"gpu":         {AllocatableDevice{Gpu: &GpuDeviceInfo{}}, GpuDeviceType, false},
...
func TestCanonicalName(t *testing.T) {
	t.Run("gpu", func(t *testing.T) {
		d := &AllocatableDevice{Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{Minor: 3}}}
	...
	t.Run("mig-static and mig-dynamic agree", func(t *testing.T) {
		static := &AllocatableDevice{MigStatic: &MigDeviceInfo{
			MigInfo: &nvidia.MigInfo{Profile: "1g.5gb"}, ParentMinor: 2, GiProfileID: 19, PlacementStart: 0,
		}}
...
func TestUUID(t *testing.T) {
	t.Run("gpu", func(t *testing.T) {
		assert.Equal(t, "GPU-abc", AllocatableDevice{Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{UUID: "GPU-abc"}}}.UUID())
	})
	t.Run("mig-static", func(t *testing.T) {
		assert.Equal(t, "MIG-def", AllocatableDevice{MigStatic: &MigDeviceInfo{MigInfo: &nvidia.MigInfo{UUID: "MIG-def"}}}.UUID())
	})
	t.Run("vfio", func(t *testing.T) {
...
func TestGetGPUPCIBusID(t *testing.T) {
	tests := map[string]struct {
		...
		"gpu":         {AllocatableDevice{Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{PciBusID: "0000:01:00.0"}}}, "0000:01:00.0"},
		"mig-static":  {AllocatableDevice{MigStatic: &MigDeviceInfo{MigInfo: &nvidia.MigInfo{Parent: &nvidia.GpuInfo{PciBusID: "0000:02:00.0"}}}}, "0000:02:00.0"},
		"mig-dynamic": {AllocatableDevice{MigDynamic: &MigSpec{Parent: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{PciBusID: "0000:03:00.0"}}}}, "0000:03:00.0"},
...
func TestGetDevice(t *testing.T) {
	...
	t.Run("gpu", func(t *testing.T) {
		...
		d := &AllocatableDevice{Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{
			Minor: 1, UUID: "GPU-1",
			CudaComputeCapability: "8.0.0", DriverVersion: nvidia.DriverVersion{
				DriverVersion:     "550.54.15",
				CudaDriverVersion: nvidia.NewCudaVersion(12, 4),
			},
		}}}
		dev := d.GetDevice(&Config{})
	...
	t.Run("mig-static", func(t *testing.T) {
		d := &AllocatableDevice{MigStatic: &MigDeviceInfo{
			MigInfo: &nvidia.MigInfo{
				UUID: "MIG-1", Profile: "1g.5gb",
				Parent: &nvidia.GpuInfo{
					CudaComputeCapability: "8.0.0", DriverVersion: nvidia.DriverVersion{
						DriverVersion:     "550.54.15",
						CudaDriverVersion: nvidia.NewCudaVersion(12, 4),
					},
			...
			ParentMinor: 2, GiProfileID: 19, PlacementStart: 0,
		}}
		dev := d.GetDevice(&Config{})
...
func buildMixedDevices() AllocatableDevices {
	return AllocatableDevices{
		"gpu-1":  {Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{Minor: 1, UUID: "GPU-bbb"}}},
		"gpu-0":  {Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{Minor: 0, UUID: "GPU-aaa"}}},
		"vfio-1": {Vfio: &VfioDeviceInfo{index: 1, UUID: "GPU-vfio-yyy"}},
		"vfio-0": {Vfio: &VfioDeviceInfo{index: 0, UUID: "GPU-vfio-xxx"}},
		"mig-0":  {MigStatic: &MigDeviceInfo{MigInfo: &nvidia.MigInfo{UUID: "MIG-mmm", Profile: "1g.5gb"}, ParentMinor: 0, GiProfileID: 19}},
...
func TestUUIDsSortedAcrossTypes(t *testing.T) {
	...
	devices := AllocatableDevices{
		"gpu-1": {Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{UUID: "GPU-bbb"}}},
		"gpu-0": {Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{UUID: "GPU-aaa"}}},
		"mig-0": {MigStatic: &MigDeviceInfo{MigInfo: &nvidia.MigInfo{UUID: "MIG-mmm"}}},
	}
...
func TestMigDeviceUUIDs(t *testing.T) {
	t.Run("static only, sorted", func(t *testing.T) {
		...
		devices := AllocatableDevices{
			"gpu-0": {Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{UUID: "GPU-excluded"}}},
			"mig-1": {MigStatic: &MigDeviceInfo{MigInfo: &nvidia.MigInfo{UUID: "MIG-bbb"}}},
			"mig-0": {MigStatic: &MigDeviceInfo{MigInfo: &nvidia.MigInfo{UUID: "MIG-aaa"}}},
	...
	t.Run("panics when DynamicMIG enabled", func(t *testing.T) {
		...
		devices := AllocatableDevices{"mig-0": {MigStatic: &MigDeviceInfo{MigInfo: &nvidia.MigInfo{UUID: "MIG-aaa"}}}}
...
func TestPerGPUAddGPUAllocatables(t *testing.T) {
	...
	gpu := &AllocatableDevice{Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{Minor: 0, UUID: "GPU-a", PciBusID: "0000:01:00.0"}}}
...
func TestPerGPUAddAllocatableDevice(t *testing.T) {
	...
	gpu := &AllocatableDevice{Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{Minor: 4, UUID: "GPU-d", PciBusID: "0000:05:00.0"}}}
...
func TestPerGPUGetAllDevicesMerges(t *testing.T) {
	...
	require.NoError(t, p.AddAllocatableDevice(
		&AllocatableDevice{Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{Minor: 0, UUID: "GPU-0", PciBusID: "0000:01:00.0"}}}))
	require.NoError(t, p.AddAllocatableDevice(
		&AllocatableDevice{Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{Minor: 1, UUID: "GPU-1", PciBusID: "0000:02:00.0"}}}))
	require.NoError(t, p.AddAllocatableDevice(
...
func TestPerGPURemoveSiblingDevices(t *testing.T) {
	pci := "0000:01:00.0"
	gpu := &AllocatableDevice{Gpu: &GpuDeviceInfo{GpuInfo: &nvidia.GpuInfo{Minor: 0, UUID: "GPU-0", PciBusID: pci}}}
