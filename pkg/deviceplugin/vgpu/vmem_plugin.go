...
var _ base.DevicePlugin = &vMemoryDevicePlugin{}

// NewVMemoryDevicePlugin returns an initialized vMemoryDevicePlugin.
func NewVMemoryDevicePlugin(resourceName, socket string, manager *manager.DeviceManager) base.DevicePlugin {
	return &vMemoryDevicePlugin{
...
func (m *vMemoryDevicePlugin) Devices() []*pluginapi.Device {
	...
	config := m.baseServer.GetDeviceManager().GetNodeConfig()
