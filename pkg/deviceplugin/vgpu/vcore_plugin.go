...
var _ base.DevicePlugin = &vCoreDevicePlugin{}

// NewVCoreDevicePlugin returns an initialized vCoreDevicePlugin.
func NewVCoreDevicePlugin(resourceName, socket string, manager *manager.DeviceManager) base.DevicePlugin {
	return &vCoreDevicePlugin{
